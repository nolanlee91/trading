# Các chỉ số trên HUD và ý nghĩa chi tiết (ver2)
...
**Ví dụ "Risk vào lệnh 5":** nằm trong nhóm **Cẩn thận**. Nghĩa là có khoảng 2 yếu tố
bất lợi cộng lại (vd: giá đang căng +2ATR (+3) và 1D ngược bias (+2) = 5). HUD kèm
phần "lý do" liệt kê đúng yếu tố nào cộng điểm, để anh biết vì sao. Risk 5 KHÔNG có
nghĩa "cấm vào" — nó nghĩa "vào lúc này hơi rủi ro, cân nhắc giảm size hoặc chờ".
...
Hiển thị dạng ✓/✗ và đếm "X/5 thuận lợi". Đây là các điều kiện để vào lệnh **thuận
trend chất lượng**. Bộ checklist ĐỔI theo bias:
...
3. **Giá gần/dưới EMA20 (pullback để mua)** — giá hồi về vùng EMA20 (dist < 0.5 ATR),
   tức mua khi giá *hồi*, không đu đỉnh.
4. **RSI không quá nóng (< 70)** — còn dư địa, không mua đỉnh quá mua.
...
3. **Giá gần/trên EMA20 (hồi lên kháng cự để bán)** — giá bật lên vùng EMA20
   (dist > -0.5 ATR), tức bán khi giá *hồi lên kháng cự*, KHÔNG đuổi bán khi đã căng xuống.
4. **RSI không quá bán (> 30)** — chưa quá bán (tránh bán ngay vùng dễ nảy).
5. **Funding không đông short (> 15 percentile)** — đám đông chưa dồn hết về short
   (tránh short khi quá nhiều người đã short → rủi ro squeeze).

**Đọc tally:** "4/5 thuận lợi" = 4 điều kiện đúng, 1 sai. Điều kiện sai cho biết
*đang thiếu gì*. Ví dụ short ETH 4/5 mà thiếu điều kiện 3 → hướng đúng nhưng **giá
đang căng xuống, chưa phải điểm vào short mới đẹp** (nên chờ hồi lên EMA20).

---

## 4. Các chỉ số ngữ cảnh khác
...
| **Funding** | Phí perp / 8h + quy năm | dương = long trả short; âm = short trả long |
...
| **Funding velocity** | Funding đang tăng hay giảm | đổi nhanh = đám đông đang ùa vào 1 chiều |
| **ATR%** | Độ biến động (ATR / giá) | để ước lượng cỡ lệnh & đặt SL |
| **Return 7 ngày** | % thay đổi giá 7 ngày | momentum trung hạn |

### ATR là gì (vì nhiều chỗ dùng)
...
dùng số tiền cố định — vì ATR tự co giãn theo độ biến động.

---

## 5. Tinh thần đọc HUD
- Bias cho biết **chiều nên theo**; Checklist cho biết **đã đủ điều kiện chưa**;
  Risk cho biết **thời điểm có rủi ro không**.
- Tất cả là **ngữ cảnh hỗ trợ**, tín hiệu edge yếu (xem `04-do-dang-tin.md`).
  Quyết định và quản trị rủi ro là của người dùng.
