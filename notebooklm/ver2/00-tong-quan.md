# Tổng quan hệ thống — Trader Decision Assistant (ver2)
...
1. **Context** — trend 4H/1D, funding percentile, RSI, khoảng cách EMA, ATR.
...
4. **Journal** — ghi lệnh thật + context lúc vào + PnL → sau 200-300 lệnh tìm edge
   cá nhân. Lưu trên PostgreSQL (dùng chung mọi thiết bị).
...
## Các tài liệu trong bộ ver2
- `00-tong-quan.md` — file này.
- `01-cach-lay-data.md` — lấy dữ liệu ở đâu, tự dò sàn, độ tươi.
- `02-chi-so-va-y-nghia.md` — **ý nghĩa CHI TIẾT từng chỉ số** (Bias, Risk, Checklist...).
- `03-cach-su-dung.md` — cách dùng (online, journal, chat, nhập tay).
- `04-do-dang-tin.md` — độ đáng tin của từng tín hiệu.
- `05-cap-nhat-v1-v2.md` — những thay đổi so với ver1.
